...
val o63 = s63.observeOn(schedulerToUse).p
  ...
  val counter = new AtomicInteger(0)
    val obs = join {
      case o1(x) && o2(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o1(x) && o3(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o4(x) && o5(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o6(x) && o7(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o8(x) && o9(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o10(x) && o11(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o12(x) && o13(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o14(x) && o15(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o16(x) && o17(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o18(x) && o19(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o20(x) && o21(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o22(x) && o23(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o24(x) && o25(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o26(x) && o27(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o28(x) && o29(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o30(x) && o31(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o32(x) && o33(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o34(x) && o35(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o36(x) && o37(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o38(x) && o39(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o40(x) && o41(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o42(x) && o43(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o44(x) && o45(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o46(x) && o47(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o48(x) && o49(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o50(x) && o51(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o52(x) && o53(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o54(x) && o55(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o56(x) && o57(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o58(x) && o59(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o60(x) && o61(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
case o62(x) && o63(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown }
    Next(()) }
    }.serialize
    obs.subscribe((_: Unit) => gotAll.countDown, (_: Throwable) => (), () => ())
...
val o61 = s61.observeOn(schedulerToUse).p
  ...
  val counter = new AtomicInteger(0)
    val obs = join {
      case o1(x) && o2(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown }
    Next(()) }
case o1(x) && o3(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown }
    Next(()) }
case o1(x) && o4(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown }
    Next(()) }
case o1(x) && o5(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown }
    Next(()) }
case o6(x) && o7(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown }
...
val o57 = s57.observeOn(schedulerToUse).p
  ...
  val counter = new AtomicInteger(0)
    val obs = join {
      case o1(x) && o2(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown }
    Next(()) }
case o1(x) && o3(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown }
    Next(()) }
...
case o1(x) && o5(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown }
    Next(()) }
case o1(x) && o6(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown }
    Next(()) }
case o1(x) && o7(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown }
    Next(()) }
case o1(x) && o8(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown }
    Next(()) }
case o1(x) && o9(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown }
    Next(()) }
case o10(x) && o11(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown }
...
val o49 = s49.observeOn(schedulerToUse).p
  ...
  val counter = new AtomicInteger(0)
    val obs = join {
      case o1(x) && o2(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o1(x) && o3(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
...
case o1(x) && o9(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o1(x) && o10(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o1(x) && o11(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o1(x) && o12(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o1(x) && o13(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o1(x) && o14(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o1(x) && o15(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o1(x) && o16(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o1(x) && o17(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
    Next(()) }
case o18(x) && o19(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown }
...
val o33 = s33.observeOn(schedulerToUse).p
  ...
  val counter = new AtomicInteger(0)
    val obs = join {
      case o1(x) && o2(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o3(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
...
case o1(x) && o17(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o18(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o19(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o20(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o21(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o22(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o23(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o24(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o25(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o26(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o27(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o28(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o29(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o30(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o31(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o32(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
case o1(x) && o33(xx) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown }
    Next(()) }
    }.serialize
    obs.subscribe((_: Unit) => gotAll.countDown, (_: Throwable) => (), () => ())
...
val o63 = s63.observeOn(schedulerToUse)
  ...
  val counter = new AtomicInteger(0)
    val p1 = RxJoinObservable.from(o1).and(o2).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p2 = RxJoinObservable.from(o1).and(o3).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p3 = RxJoinObservable.from(o4).and(o5).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p4 = RxJoinObservable.from(o6).and(o7).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p5 = RxJoinObservable.from(o8).and(o9).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p6 = RxJoinObservable.from(o10).and(o11).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p7 = RxJoinObservable.from(o12).and(o13).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p8 = RxJoinObservable.from(o14).and(o15).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p9 = RxJoinObservable.from(o16).and(o17).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p10 = RxJoinObservable.from(o18).and(o19).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p11 = RxJoinObservable.from(o20).and(o21).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p12 = RxJoinObservable.from(o22).and(o23).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p13 = RxJoinObservable.from(o24).and(o25).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p14 = RxJoinObservable.from(o26).and(o27).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p15 = RxJoinObservable.from(o28).and(o29).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p16 = RxJoinObservable.from(o30).and(o31).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p17 = RxJoinObservable.from(o32).and(o33).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p18 = RxJoinObservable.from(o34).and(o35).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p19 = RxJoinObservable.from(o36).and(o37).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p20 = RxJoinObservable.from(o38).and(o39).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p21 = RxJoinObservable.from(o40).and(o41).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p22 = RxJoinObservable.from(o42).and(o43).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p23 = RxJoinObservable.from(o44).and(o45).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p24 = RxJoinObservable.from(o46).and(o47).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p25 = RxJoinObservable.from(o48).and(o49).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p26 = RxJoinObservable.from(o50).and(o51).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p27 = RxJoinObservable.from(o52).and(o53).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p28 = RxJoinObservable.from(o54).and(o55).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p29 = RxJoinObservable.from(o56).and(o57).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p30 = RxJoinObservable.from(o58).and(o59).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p31 = RxJoinObservable.from(o60).and(o61).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val p32 = RxJoinObservable.from(o62).and(o63).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 31)) { latch.countDown } })
val obs = RxJoinObservable.when(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32).toObservable
    obs.subscribe((_: Unit) => gotAll.countDown, (_: Throwable) => (), () => ())
    val thread1 = sendIndexFromThread(s1, internalSize)
...
val p2 = RxJoinObservable.from(o1).and(o3).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p3 = RxJoinObservable.from(o1).and(o4).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p4 = RxJoinObservable.from(o1).and(o5).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p5 = RxJoinObservable.from(o6).and(o7).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p6 = RxJoinObservable.from(o8).and(o9).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p7 = RxJoinObservable.from(o10).and(o11).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p8 = RxJoinObservable.from(o12).and(o13).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p9 = RxJoinObservable.from(o14).and(o15).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p10 = RxJoinObservable.from(o16).and(o17).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p11 = RxJoinObservable.from(o18).and(o19).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p12 = RxJoinObservable.from(o20).and(o21).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p13 = RxJoinObservable.from(o22).and(o23).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p14 = RxJoinObservable.from(o24).and(o25).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p15 = RxJoinObservable.from(o26).and(o27).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p16 = RxJoinObservable.from(o28).and(o29).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p17 = RxJoinObservable.from(o30).and(o31).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p18 = RxJoinObservable.from(o32).and(o33).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p19 = RxJoinObservable.from(o34).and(o35).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p20 = RxJoinObservable.from(o36).and(o37).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p21 = RxJoinObservable.from(o38).and(o39).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p22 = RxJoinObservable.from(o40).and(o41).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p23 = RxJoinObservable.from(o42).and(o43).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p24 = RxJoinObservable.from(o44).and(o45).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p25 = RxJoinObservable.from(o46).and(o47).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p26 = RxJoinObservable.from(o48).and(o49).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p27 = RxJoinObservable.from(o50).and(o51).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p28 = RxJoinObservable.from(o52).and(o53).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p29 = RxJoinObservable.from(o54).and(o55).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p30 = RxJoinObservable.from(o56).and(o57).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p31 = RxJoinObservable.from(o58).and(o59).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val p32 = RxJoinObservable.from(o60).and(o61).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 29)) { latch.countDown } })
val obs = RxJoinObservable.when(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32).toObservable
    obs.subscribe((_: Unit) => gotAll.countDown, (_: Throwable) => (), () => ())
    val thread1 = sendIndexFromThread(s1, internalSize)
...
val p4 = RxJoinObservable.from(o1).and(o5).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p5 = RxJoinObservable.from(o1).and(o6).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p6 = RxJoinObservable.from(o1).and(o7).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p7 = RxJoinObservable.from(o1).and(o8).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p8 = RxJoinObservable.from(o1).and(o9).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p9 = RxJoinObservable.from(o10).and(o11).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p10 = RxJoinObservable.from(o12).and(o13).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p11 = RxJoinObservable.from(o14).and(o15).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p12 = RxJoinObservable.from(o16).and(o17).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p13 = RxJoinObservable.from(o18).and(o19).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p14 = RxJoinObservable.from(o20).and(o21).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p15 = RxJoinObservable.from(o22).and(o23).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p16 = RxJoinObservable.from(o24).and(o25).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p17 = RxJoinObservable.from(o26).and(o27).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p18 = RxJoinObservable.from(o28).and(o29).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p19 = RxJoinObservable.from(o30).and(o31).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p20 = RxJoinObservable.from(o32).and(o33).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p21 = RxJoinObservable.from(o34).and(o35).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p22 = RxJoinObservable.from(o36).and(o37).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p23 = RxJoinObservable.from(o38).and(o39).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p24 = RxJoinObservable.from(o40).and(o41).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p25 = RxJoinObservable.from(o42).and(o43).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p26 = RxJoinObservable.from(o44).and(o45).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p27 = RxJoinObservable.from(o46).and(o47).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p28 = RxJoinObservable.from(o48).and(o49).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p29 = RxJoinObservable.from(o50).and(o51).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p30 = RxJoinObservable.from(o52).and(o53).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p31 = RxJoinObservable.from(o54).and(o55).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val p32 = RxJoinObservable.from(o56).and(o57).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 25)) { latch.countDown } })
val obs = RxJoinObservable.when(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32).toObservable
    obs.subscribe((_: Unit) => gotAll.countDown, (_: Throwable) => (), () => ())
    val thread1 = sendIndexFromThread(s1, internalSize)
...
val p8 = RxJoinObservable.from(o1).and(o9).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p9 = RxJoinObservable.from(o1).and(o10).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p10 = RxJoinObservable.from(o1).and(o11).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p11 = RxJoinObservable.from(o1).and(o12).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p12 = RxJoinObservable.from(o1).and(o13).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p13 = RxJoinObservable.from(o1).and(o14).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p14 = RxJoinObservable.from(o1).and(o15).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p15 = RxJoinObservable.from(o1).and(o16).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p16 = RxJoinObservable.from(o1).and(o17).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p17 = RxJoinObservable.from(o18).and(o19).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p18 = RxJoinObservable.from(o20).and(o21).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p19 = RxJoinObservable.from(o22).and(o23).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p20 = RxJoinObservable.from(o24).and(o25).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p21 = RxJoinObservable.from(o26).and(o27).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p22 = RxJoinObservable.from(o28).and(o29).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p23 = RxJoinObservable.from(o30).and(o31).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p24 = RxJoinObservable.from(o32).and(o33).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p25 = RxJoinObservable.from(o34).and(o35).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p26 = RxJoinObservable.from(o36).and(o37).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p27 = RxJoinObservable.from(o38).and(o39).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p28 = RxJoinObservable.from(o40).and(o41).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p29 = RxJoinObservable.from(o42).and(o43).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p30 = RxJoinObservable.from(o44).and(o45).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p31 = RxJoinObservable.from(o46).and(o47).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val p32 = RxJoinObservable.from(o48).and(o49).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 17)) { latch.countDown } })
val obs = RxJoinObservable.when(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32).toObservable
    obs.subscribe((_: Unit) => gotAll.countDown, (_: Throwable) => (), () => ())
    val thread1 = sendIndexFromThread(s1, internalSize)
...
val p16 = RxJoinObservable.from(o1).and(o17).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p17 = RxJoinObservable.from(o1).and(o18).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p18 = RxJoinObservable.from(o1).and(o19).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p19 = RxJoinObservable.from(o1).and(o20).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p20 = RxJoinObservable.from(o1).and(o21).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p21 = RxJoinObservable.from(o1).and(o22).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p22 = RxJoinObservable.from(o1).and(o23).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p23 = RxJoinObservable.from(o1).and(o24).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p24 = RxJoinObservable.from(o1).and(o25).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p25 = RxJoinObservable.from(o1).and(o26).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p26 = RxJoinObservable.from(o1).and(o27).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p27 = RxJoinObservable.from(o1).and(o28).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p28 = RxJoinObservable.from(o1).and(o29).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p29 = RxJoinObservable.from(o1).and(o30).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p30 = RxJoinObservable.from(o1).and(o31).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p31 = RxJoinObservable.from(o1).and(o32).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val p32 = RxJoinObservable.from(o1).and(o33).then((x: Int, xx: Int) => { counter.incrementAndGet()
    if (counter.get == (internalSize * 1)) { latch.countDown } })
val obs = RxJoinObservable.when(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32).toObservable
    obs.subscribe((_: Unit) => gotAll.countDown, (_: Throwable) => (), () => ())
    val thread1 = sendIndexFromThread(s1, internalSize)
