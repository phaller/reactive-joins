    ...
    exec.independentSamples -> 8) in
    {
      using(nCasesTwoIndependentOutRange) curve ("Non-Deterministic Choice") in { nChoices =>
        ...
        if (nChoices == 32) {
          ...
          val latch = new CountDownLatch(1048576)
          val obs = join {
            case o1(x) && o2(xx) => { Next(1) }
            case o3(x) && o4(xx) => { Next(1) }
            case o5(x) && o6(xx) => { Next(1) }
          ...
          val thread31 = sendIndexFromThread(s31, 32768)
          val thread32 = sendIndexFromThread(s32, 32768)
          val thread33 = sendIndexFromThread(s33, 32768)
          val thread34 = sendIndexFromThread(s34, 32768)
          val thread35 = sendIndexFromThread(s35, 32768)
          val thread36 = sendIndexFromThread(s36, 32768)
          val thread37 = sendIndexFromThread(s37, 32768)
          val thread38 = sendIndexFromThread(s38, 32768)
          val thread39 = sendIndexFromThread(s39, 32768)
          val thread40 = sendIndexFromThread(s40, 32768)
          val thread41 = sendIndexFromThread(s41, 32768)
          val thread42 = sendIndexFromThread(s42, 32768)
          val thread43 = sendIndexFromThread(s43, 32768)
          val thread44 = sendIndexFromThread(s44, 32768)
          val thread45 = sendIndexFromThread(s45, 32768)
          val thread46 = sendIndexFromThread(s46, 32768)
          val thread47 = sendIndexFromThread(s47, 32768)
          val thread48 = sendIndexFromThread(s48, 32768)
          val thread49 = sendIndexFromThread(s49, 32768)
          val thread50 = sendIndexFromThread(s50, 32768)
          val thread51 = sendIndexFromThread(s51, 32768)
          val thread52 = sendIndexFromThread(s52, 32768)
          val thread53 = sendIndexFromThread(s53, 32768)
          val thread54 = sendIndexFromThread(s54, 32768)
          val thread55 = sendIndexFromThread(s55, 32768)
          val thread56 = sendIndexFromThread(s56, 32768)
          val thread57 = sendIndexFromThread(s57, 32768)
          val thread58 = sendIndexFromThread(s58, 32768)
          val thread59 = sendIndexFromThread(s59, 32768)
          val thread60 = sendIndexFromThread(s60, 32768)
          val thread61 = sendIndexFromThread(s61, 32768)
          val thread62 = sendIndexFromThread(s62, 32768)
          val thread63 = sendIndexFromThread(s63, 32768)
          val thread64 = sendIndexFromThread(s64, 32768)
